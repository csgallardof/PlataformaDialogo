          ...
          <table cellspacing="0" cellpadding="0" width="100%">
            <tr>
              <td class="hide-for-mobile" style="padding:30px 0 10px 0;">
                <!--<img width="140" height="51" src="..\..\..\imagenes_dialogo_nacional\diseno_final\logo_dialogo_nacional.png" alt="logo dialogo nacional" />-->
                <img width="140" height="51" src="https://image.ibb.co/kYj2Cp/logo_dialogo_nacional.png" alt="logo dialogo nacional" />
              </td>
            </tr>
            ...
            <tr>
              <td class="hide-for-mobile"  height="150" valign="top" >
                <b>
                  <span>Plataforma de Dialogo Nacional</span>
                  </b>
                <br>
                <span>Venezuela N3-66 entre Sucre y Espejo 
                      <br>Quito - Ecuador 
                      <br>Tel&eacutefono: 593-2 228-8367</span>
              </td>
            </tr>

            <tr>
              <td class="hide-for-mobile" style="height:50%; width:15%">
                <!--<img width="180" height="299"src="..\..\..\imagenes_dialogo_nacional\diseno_final\footer_logos_3.png" alt="logo de pie, esquema de aves de colores" />-->
                <img style="vertical-align: bottom;" width="100%" height="100%" src="https://image.ibb.co/cfvdJU/footer_logos_3.png" alt="logo de pie, esquema de aves de colores" />
                      ...
                      <table cellspacing="0" cellpadding="10" width="100%">
                        <tr>
                          ...
                          <td width="150" style="width:229px;">
                            <a href="http://localhost:8000/PlataformaDialogo" class="myButton" name="h_solicitud" id="h_solicitud">Ver Detalle de Propuesta</a>
