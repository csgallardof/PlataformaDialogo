...
<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right fit-m-b-10">
				<li><a href="{{ url('consejo-sectorial/home') }}">Inicio</a></li>
			...
			<div class="row">
				<!-- begin col-8 -->
				<div class="col-md-12">
					<a class="btn btn-primary  m-b-30 m-l-30" href="{{ url('consejo-sectorial/verSolucion/despliegue/1',[$solucion->id]) }}">Regresar</a>
