...
Route::get('/cargar-archivo-dialogo', 'DialogoNacionalController@vistaregistroArchivo');
Route::post('/vista-Previa-Mesas', [
    'uses' => 'DialogoNacionalController@cargarDatosExcel',
    'as' => 'dialogoNacional.soluciones.cargarDatosExcel'
]);
Route::get('/partipantes/vistaPrevia/{nombreArchivo}', 'DialogoNacionalController@vistaPreviaRegistro');

Route::post('/participantes/vistaPreviaRegistroDialogo', [
    'uses' => 'DialogoNacionalController@cargarPropuestas',
    'as' => 'CargarPropuestas'
]);
...
/*Route::get('/listar-usuario-consejo-sectorial', 'ConsejoSectorialController@indexUsuarioConsejoSectorial');
Route::get('/listar-aprobacion-consejo-sectorial', 'ConsejoSectorialController@indexAprobacionConsejoSectorial');
Route::get('/crear-usuarios-consejo-sectorial', 'ConsejoSectorialController@crearUsuarioConsejoSectorial');
Route::get('/editar-usuario-consejo-sectorial', 'ConsejoSectorialController@editarUsuarioConsejoSectorial');
*/
//MODULO LISTAR
//@Fabian Quinatoa
//Route::get('/crear-alerta', 'ConsejoSectorialController@create');
//Route::get('/editar-alerta', 'ConsejoSectorialController@editar');
//Route::get('/listar-alerta', 'ConsejoSectorialController@index');
